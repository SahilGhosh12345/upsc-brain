    ...
    <div className="max-w-4xl mx-auto p-4">
      <Card>
        ...
        <CardContent>
          ...
          {analysis && <div className="mt-6"><h3 className="text-xl font-semibold">Analysis Results</h3><div className=""bg-gray-50 dark:bg-black p-6 rounded ">{renderAnalysis(analysis)}</div></div>}
        </CardContent>
      </Card>
    </div>
  );
